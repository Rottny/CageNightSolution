...
namespace DataLayer.Classes
{
    ...
    {
        #region Dictionaries & Count-properties
        ...
        /** Keep track of current amount of items in database! */
        ...
        public DataBase()
        {
            ...
            #region MOCVALUES
            #region Videos
            var dummyVideo = new Video(MOCVALUES.videoID1, MOCVALUES.genreID1, true, "The Rock", 4);
            var dummyVideo2 = new Video(MOCVALUES.videoID2, MOCVALUES.genreID2, true, "Face Off", 6);
            var dummyVideo3 = new Video(MOCVALUES.videoID3, MOCVALUES.genreID3, false, "Con Air", 3);
            ...
            #region Bookings
            var dummyBooking = new VideoBooking(
                MOCVALUES.videobookingID1, MOCVALUES.videoID1, MOCVALUES.customerID1, DateTime.Now.AddDays(-2), DateTime.MinValue, "N.Cage");
            /**The Rock, 
             * Patricia Arquette, 
             * DateTime.Now, 
            ...
            var dummyBooking2 = new VideoBooking(
                MOCVALUES.videobookingID2, MOCVALUES.videoID2, MOCVALUES.customerID2, DateTime.Now.AddDays(-2), DateTime.MinValue, "Not.Cage");
            /**The Face Off, 
             * Lisa Marie Presley, 
         ...
         *  ITEM checks for an item with a number of matching qualities, I.E Name, GenreID...etc.. ( Optional! )
            Throws a VideoRentalException if both ID, NAME and ITEM are default or null! */
